export const pizzas = [
  ...
  // Simulación de un carrito de compras /Solo ers necesario modificar la info en pizzas, sera el unico segmento que tiene el codigo hardcodeado
  export const pizzaCart = [
    {
      ...pizzas.find(pizza => pizza.id === 'P001'),
      count: 1,
    },
    {
      ...pizzas.find(pizza => pizza.id === 'P002'),
      count: 1,
    },
    {
      ...pizzas.find(pizza => pizza.id === 'P003'),
      count: 1,
    },
    {
      ...pizzas.find(pizza => pizza.id === 'P004'),
      count: 1,
    },
    {
      ...pizzas.find(pizza => pizza.id === 'P005'),
      count: 1,
    },
    {
      ...pizzas.find(pizza => pizza.id === 'P006'),
      count: 1,
    },
  ];
